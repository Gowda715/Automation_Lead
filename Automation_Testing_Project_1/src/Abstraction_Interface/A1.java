...
public class A1 {
	...
	public static void main(String[] args) throws ParseException {
		String sDate1="31/12/1998"; 
		 ...
		 Date date2=(Date) formatter2.parse(sDate2); 
		 Date date3=(Date) formatter3.parse(sDate3); 
		 Date date4=(Date) formatter4.parse(sDate4); 
		 Date date5=(Date) formatter5.parse(sDate5); 
